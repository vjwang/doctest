...
<p><em>GATEWAY_HOME</em>/lib/client/c/<em>OS</em>/AMQP-0-9-1/lib</p>
...
To Use the \${gateway.name.long} C AMQP Client Library
------------------------------------------------------
